...
PYBIND11_MODULE(PyCeleX5, m)
{
    ...
    py::class_<PyCeleX5>(m, "PyCeleX5")
        ...
        .def("startRippingBinFile", &PyCeleX5::startRippingBinFile, "void startRippingBinFile()")
        .def("stopRippingBinFile", &PyCeleX5::stopRippingBinFile, "void stopRippingBinFile()")
        .def("enableImageFileOutput", &PyCeleX5::enableImageFileOutput, "void enableImageFileOutput(string directoryPath)", py::arg("directoryPath"))
        .def("enableEventDataOutput", &PyCeleX5::enableEventDataOutput, "void enableEventDataOutput(string filePath)", py::arg("filePath"))
        .def("rippingBinFileFinished", &PyCeleX5::rippingBinFileFinished, "bool rippingBinFileFinished()")
        ...
        .def("getEventDataVector", &PyCeleX5::getEventDataVector, "bool getEventDataVector(vector<EventData>) vecEvent")
