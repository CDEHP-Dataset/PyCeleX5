...
PYBIND11_MODULE(PyCeleX5, m)
{
    ...
    py::class_<PyCeleX5>(m, "PyCeleX5")
        ...
        .def("disableEventCountDensity", &PyCeleX5::disableEventCountDensity, "void disableEventCountDensity()")
        .def("enableEventCountDensity", &PyCeleX5::enableEventCountDensity, "void enableEventCountDensity()")
        .def("isEventCountDensityEnabled", &PyCeleX5::isEventCountDensityEnabled, "bool isEventCountDensityEnabled()")
